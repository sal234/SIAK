...
<html>
<head>
    <title>SIAK " Sistem Informasi Administrasi Kependudukan"</title>
    ...
    <div id="main">
        <div id="header">
            <div style="border-bottom:2px solid #FF7600;font-size:3em;font-weight:bolder;color:#FF7600;padding-left:10px;">
				SIAK
				<span style="font-size:45%;font-style:italic">Sistem Informasi Administrasi Kependudukan</span>
				</div>
       </div>  
       <div id="middle">
            <div id="left-column">
                ...
                <h3>User</h3>
                <ul class="nav">
                    <li><a href="resetpw.php">Ganti Password</a></li>
       ...
       <!---     
        ...
        <div id="footer"><p>Developed by Kelompok 1 2019 </div>  
    </div>
</body>
</html>
<style>
