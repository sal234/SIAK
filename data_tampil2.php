...
if($sql_exe){
    ...
    $tampil .="<tr>";
			...
			$tampil .= "<th class='full' colspan='2'>Pilihan</th>";	
			$tampil .= "</tr>";				
		while($data = mysqli_fetch_row($sql_exe)){
			...
			$tampil .= "<td class='id link' onclick='lihat_data(this,\"".$tabel."\")' title='".$data[0]."'><img src='img/search.png'></td><td class='id link' title='".$data[0]."' onclick='hapus_data(this,\"".$nama_id."\",\"".$tabel."\")'><img src='img/b_usrdrop.png' /></td><td class='id link' title='".$data[0]."' onclick='cetak(this,\"".$nama_id."\",\"".$tabel."\")'><img src='img/print.png' /></td>";	
			$tampil .= "</tr>";
			}
$tampil .= "</table>";
